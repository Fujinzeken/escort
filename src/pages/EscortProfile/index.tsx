...
function EscortProfile() {
  ...
  const escortSignUp = async () => {
    if (name.length < 4) {
      toast.error("Working Name must be at least 4 letters long");
      return;
    }
    if (!email.includes("@")) {
    ...
    if (password.length < 8) {
      toast.error("Password must be at least 8 letters long");
      return;
    }
    ...
    if (!checked) {
      toast.error("Please agree to our terms of service to continue");
      return;
    }
    ...
    try {
      ...
      const res = await axios.post(
        "https://lazer-escort.onrender.com/escort/signup",
        { workingName: name, email: email, password: password }
      );
  ...
  return (
    <div>
      <div
        className="main bg-cover bg-no-repeat "
        style={{
      ...
      >
        ...
        <section className="flex mt-[5rem] items-center justify-center ">
          <div
            className="escort-cruel w-[70%] flex p-[3rem]"
          ...
          >
            <div className="p-4" style={{ borderRight: "1px solid gainsboro" }}>
              ...
              <p>
                Welcome to Tryst.link, home of the independent escort! We’re
                excited that you want to join us. Before you create your account
                there are some important things you need to agree to:
              </p>
              <ul className="p-4 escort-list">
                <li>
                  <p>
                    ...
                    agree not to offer any services that are prohibited in that
                    jurisdiction.
                  </p>
                </li>
                <li>
                  <p>
                    <span style={{ fontWeight: "600" }}>
                      You must provide valid identification to verify your age{" "}
                    </span>
                ...
                <li>
                  <p>
                    ...
                    that you do not share with any other worker or business.
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    professionally taken but they must be high resolution..
                  </p>
                </li>
                <li>
                  <p>
              ...
              <p>
                TRYST RESERVES THE RIGHT TO REFUSE ADVERTISING AT OUR
                DISCRETION, AS WE ENDEAVOUR TO MAINTAIN A HIGH STANDARD IN
                QUALITY, IMAGE PRESENTATION, AND INTEGRITY.
              </p>
            </div>
            <div className="p-4">
              <h1 className="text-[32px] mb-4">Provider sign up</h1>
              <section
                className="p-[.8rem] mb-[.5rem]"
                style={{ backgroundColor: "#D5DDE4", borderRadius: ".3rem" }}
              >
                <p>
                  <span style={{ fontWeight: "600" }}>
                    Want contact Provides?{" "}
                  </span>
                  <span
              ...
              <div className="page-inputs flex flex-col">
                <span style={{ fontWeight: "600" }}>Working Name</span>
                <input
                  type="text"
                  value={name}
                ...
                />
                <p>
                  Your working name, not your legal name. No locations, emojis,
                  or symbols please.
                </p>
              </div>
              <div className="page-inputs flex flex-col ">
                ...
                <p>
                  ...
                  <span style={{ fontWeight: "600" }}> strong, unique </span>
                  password to protect your account.{" "}
                  <span style={{ fontWeight: "600" }}>
                    Check out our password recommendations page{" "}
                  </span>
              ...
              <div className="page-inputs flex flex-col">
                <span style={{ fontWeight: "600" }}>Repeat your password</span>
                <input
                  type="password"
                  value={confirmPass}
                ...
                />
                <p>
                  Repeat password should be exactly the same as password entered
                </p>
              </div>
              ...
              <section className="items-center flex flex-col">
                <p>
                  By signing up to Tryst.link you agree that you are doing so of
                  your own free will, free of outside pressure, and that you
                  have read and agreed to our{" "}
                  <span style={{ fontWeight: "600" }}>
                    Advertising Policy, Terms and conditions , Code of Conduct{" "}
                  </span>{" "}
                  and Privacy Policy
                </p>
                <button
                  onClick={escortSignUp}
                  className="p-[.5rem] w-[90%] mt-[1rem]"
                  style={{
                    color: "white",
                    borderRadius: ".4rem",
                    backgroundColor: "#FD4A5C",
                  }}
                >
                  {!loading ? (
                    "Sign Up"
