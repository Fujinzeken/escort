                ...
                <div className="flex flex-col items-center justify-start w-full">
                  ...
                  <div className="flex flex-col items-center justify-start w-full">
                    ...
                    >
                      ...
                      <div className=" leftNav active flex flex-1 flex-col items-center justify-start my-0 px-2 w-full">
                        <div className="flex flex-col items-center justify-start py-4 w-[79%] md:w-full">
                          <div className="flex flex-col items-start justify-start w-full">
                            <div className="flex gap-3 items-center justify-start">
                              <Img
                    ...
                    {/* <div
                        onClick={ratedPage}
                        className="rated flex flex-col justify-start w-full"
                      >
                              ...
                              <div className="h-[50px] input-message-wrapper w-[90%] flex items-center md:w-full">
                                ...
                                >
                                  <g clip-path="url(#clip0_1_6206)">
                                    <path
                                      d="M14.0188 13.2462L4.60385 14.815C4.49561 14.833 4.39403 14.8793 4.30933 14.9491C4.22463 15.0188 4.1598 15.1097 4.12135 15.2125L0.8751 23.91C0.5651 24.71 1.40135 25.4725 2.16885 25.0875L24.6688 13.8375C24.8244 13.7595 24.9551 13.6399 25.0465 13.4918C25.1379 13.3438 25.1863 13.1733 25.1863 12.9993C25.1863 12.8254 25.1379 12.6549 25.0465 12.5069C24.9551 12.3588 24.8244 12.2392 24.6688 12.1612L2.16885 0.911222C1.40135 0.527472 0.5651 1.28997 0.8751 2.08872L4.1226 10.7862C4.16105 10.889 4.22588 10.9799 4.31058 11.0496C4.39528 11.1194 4.49686 11.1657 4.6051 11.1837L14.0201 12.7525C14.0788 12.7618 14.1323 12.7919 14.1709 12.8371C14.2095 12.8823 14.2307 12.9399 14.2307 12.9993C14.2307 13.0588 14.2095 13.1163 14.1709 13.1616C14.1323 13.2068 14.0788 13.2368 14.0201 13.2462H14.0188Z"
                                      fill="#EE2C55"
                                    />
                                  </g>
                                  <defs>
