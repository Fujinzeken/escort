  ...
  const getDashboardData = async () => {
    ...
    try {
      const res = await axios.get(
        "https://lazer-escort.onrender.com/escort/dashboard",
  ...
  return (
    <>
      <div>
        ...
        >
          ...
          <div className="flex items-center justify-start">
            <section className="flex w-[85%] justify-between">
              <div
                className="side-nav items-center p-2 w-[268px] flex flex-col ml-[1.5rem]"
                style={{
                    ...
                    <li>
                      ...
                      >
                        <g clip-path="url(#clip0_315_410)">
                          <path
                            d="M14.9541 7.39062L18.5625 11L14.9541 14.6094"
                            stroke="black"
                            stroke-width="2"
              ...
              <div className="dashboard-wrapper w-[65%]">
                ...
                <section className="grid-cols-2 dahs grid gap-[20px] w-[100%]">
                  <div
                    className="items-center flex p-[.8rem]"
                    style={{
                  ...
                  >
                    ...
                    <section className="ml-2">
                      <h1 style={{ fontSize: "24px", lineHeight: "1" }}>
                        {escortData?.remainingInterests}
                      </h1>
                      <p>Removing interests</p>
                    </section>
                  </div>
                  <div
                    className=" flex items-center p-[.8rem]"
                    style={{
                  ...
                  >
                    ...
                    <section className="ml-2">
                      <h1>{escortData?.remainingContactView}</h1>
                  ...
                  >
                    ...
                    <section className="ml-2">
                      <h1>{escortData?.imageUploaded}</h1>
                      <p>Image Uploaded</p>
                    </section>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <section className="ml-2">
                      <h1>{escortData?.currentEscort}</h1>
                      <p>Current escort</p>
                    </section>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <section className="ml-2">
                      <h1>{escortData?.interestRequests}</h1>
                      <p>Interests requests</p>
                    </section>
                  </div>
                </section>
                <section
                  className="p-4 mt-[2rem]"
                  style={{
                    backgroundColor: "white",
                    borderRadius: ".5rem",
                    boxShadow: "1px 2px 11px lightgrey",
                  }}
                >
                  <h1
                    className="p-4"
                  ...
                  <div>
                    ...
                    >
                      {escortData?.currentPackage?.tier !== ""
                        ? escortData?.currentPackage?.tier
                        : "Free"}
                    </h1>
                    <section className="p-2 ml-4" style={{ color: "#999999" }}>
                      <p>
                        {escortData?.currentPackage?.advertPost} Exscort Advert
                        post
                      </p>
                      <p>
                        {escortData?.currentPackage?.contactView} Contact View
                      </p>
                      <p>
                        {escortData?.currentPackage?.imageUpload} Image Upload
                      </p>
                    </section>
                    <section style={{ color: "#999999" }}>
                      <p>
                        Package expiry date :{" "}
                        {escortData?.currentPackage?.expiryDate}
                      </p>
                      <button
                        className="p-2 mt-2"
                        style={{
        ...
        <div className="flex flex-col w-full items-center justify-center mb-10 pl-[200px]">
          <div className="flex w-2/3 mb-6">
            <h2 className="font-bold">Current Escort Request</h2>
          </div>

          {escortData?.requests?.length > 0 ? (
            <div className="flex items-center justify-center w-4/5 px-8">
              <table className="w-full text-white px-8 rounded">
                <thead className="rounded" style={{ background: "#fd00b3" }}>
                  <tr>
        ...
        <div className="flex flex-col w-full items-center justify-center pl-[200px] mt-10">
          <div className="flex w-2/3 mb-6">
            <h2 className="font-bold">Pending Escort Request</h2>
          </div>
          {escortData?.requests?.length > 0 ? (
            <table className="w-full text-white">
              <thead className="bg-fd00b3">
                <tr>
                  <td className="py-2">S/N</td>
                  <td className="py-2">Name</td>
                  <td className="py-2">Age</td>
              ...
              <tbody>
                {escortData?.requests?.map((data, i) => (
                  <tr>
