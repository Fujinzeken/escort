    ...
    <div>
      <nav className="flex flex-col">
        ...
        >
          ...
          <path
            d="M-10 0V-10H-20V0H-10ZM1433 0H1443V-10H1433V0ZM1433 10V20H1443V10H1433ZM-10 10H-20V20H-10V10ZM-10 10H1433V-10H-10V10ZM1423 0V10H1443V0H1423ZM1433 0H-10V20H1433V0ZM0 10V0H-20V10H0Z"
            fill="#FD00B3"
            mask="url(#path-1-inside-1_316_1344)"
          />
        </svg>
        <section
          className="logot mt-4"
          style={{ height: "50px", width: "100%", backgroundColor: "white" }}
        >
          <img src={logo} alt="" />
        </section>
      </nav>
      <section
        className="main pt-[4rem] bg-cover bg-no-repeat "
        style={{
      ...
      >
        <section className="flex justify-between w-full">
          <div
            className="side-nav h-fit p-2 w-[268px] flex flex-col items-center ml-[1.5rem]"
            style={{
          ...
          >
            <section className="mt-4 flex flex-col w-[80%] items-center">
              ...
              <button
                className="p-2 w-[100%]"
                style={{ backgroundColor: "#FD2C7926", borderRadius: ".3rem" }}
              >
                Public Profile
              </button>
            </section>
          ...
          <div className="w-[70%] mr-[2rem] ">
            ...
            >
              <h1 style={{ color: "#FD00B3" }}>ADD MY PROFILE</h1>
              <div
                className="flex mt-2 escort-add-btn"
                style={{ color: "#6E6E6E" }}
              >
                ...
                <button
                  style={{ padding: ".5rem", borderLeft: "1px solid #DDDDDD" }}
                >
                  Photos
                </button>
                <button
            ...
            <section className="mt-[4rem] escort-submit-form">
              ...
              <section
                className=" mt-4 grid-form gap-[20px] grid grid-cols-2"
                style={{ color: "black" }}
              >
                <div>
                  <h1>Age</h1>
